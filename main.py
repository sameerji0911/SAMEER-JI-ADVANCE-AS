...
image_urls = [
    "https://files.catbox.moe/b694bq.jpg",
    "https://files.catbox.moe/ehx1x4.jpg",
    "https://files.catbox.moe/8fffzm.jpg",
    "https://files.catbox.moe/451lrx.jpg",
    "https://files.catbox.moe/e6ucj5.jpg",
    "https://files.catbox.moe/bgkyn9.jpg",
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        f"╭━━━━━━━✦✧✦━━━━━━━╮\n"
        f"💥 𝗦𝗨𝗡𝗡𝗬 𝗟𝗘𝗢𝗡𝗘 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦\n"
        f"╰━━━━━━━✦✧✦━━━━━━━╯\n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n" 
        f"📌 𝗠𝗮𝗶𝗻 𝗙𝗲𝗮𝘁𝘂𝗿𝗲𝘀:\n\n"  
        f"➥ /start – Bot Status Check\n"
        f"➥ /leone – Extract from .txt (Auto)\n"
        ...
        f"╭────────⊰◆⊱────────╮\n"   
        f" ➠ 𝐌𝐚𝐝𝐞 𝐁𝐲 : [𝗦𝗨𝗡𝗡𝗬 𝗟𝗘𝗢𝗡𝗘](https://t.me/ASPSIR01) 💻\n"
        f"╰────────⊰◆⊱────────╯\n"
        )
    )                    
...
@bot.on_message(filters.command(["leone"]) )
async def txt_handler(bot: Client, m: Message):  
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:
                cc = f'\n┌── ⋆⋅☆⋅⋆ ──┐**\n✦ {str(count).zfill(3)} ✦\n**└── ⋆⋅☆⋅⋆ ──┘\n\n**.♡ 🦋𝗟𝗘𝗖 𝗡𝗔𝗠𝗘 ➥** `{name1}`\n**├── Extention :** @ASPSIR01 .mkv\n**├── Resolution :** [{res}]\n\n** 🎯  𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘 ➥** `{b_name}`\n\n**🥏 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ➽ **\n\n╭─✨─────────.★..─╮ **\n\n {CR}\n\n*╰─..★.─────────✨─╯ **\n\n➽──────'[𓆩♡𓆪𝗔𝗦𝗣𓆩☻𓆪](https://t.me/ASPSIR9)────────❥'
                cc1 = f'\n┌── ⋆⋅☆⋅⋆ ──┐**\n✦ {str(count).zfill(3)} ✦\n**└── ⋆⋅☆⋅⋆ ──┘\n\n**⚜ 𝗣𝗗𝗙 𝗡𝗔𝗠𝗘 ➥** `{name1}`\n**├── Extention :**  @ASPSIR01 .pdf\n\n** 🎯  𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘 ➥** `{b_name}`\n\n**🥏 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ➽**\n\n╭─✨─────────.★..─╮ **\n\n {CR}\n\n**╰─..★.─────────✨─╯ **\n\n➽──────'[𓆩♡𓆪𝗔𝗦𝗣𓆩☻𓆪](https://t.me/ASPSIR9)────────❥'
                cczip = f'\n┌── ⋆⋅☆⋅⋆ ──┐**\n✦ {str(count).zfill(3)} ✦\n**└── ⋆⋅☆⋅⋆ ──┘\n\n**⚜ 𝗣𝗗𝗙 𝗡𝗔𝗠𝗘 ➥** `{name1}`\n**├── Extention :**  @ASPSIR01 .zip\n\n** 🎯  𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘 ➥** `{b_name}`\n\n**🥏 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ➽** \n\n╭─✨─────────.★..─╮ **\n\n{CR}\n\n**╰─..★.─────────✨─╯ **\n\n➽──────'[𓆩♡𓆪𝗔𝗦𝗣𓆩☻𓆪](https://t.me/ASPSIR9)────────❥'
                ccimg = f'\n┌── ⋆⋅☆⋅⋆ ──┐**\n✦ {str(count).zfill(3)} ✦\n**└── ⋆⋅☆⋅⋆ ──┘\n\n**🖼️ Title :** `{name1}`\n**├── Extention :**  @ASPSIR01 .jpg\n\n** 🎯  𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘 ➥** `{b_name}`\n\n**🥏 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ➽**\n\n╭─✨─────────.★..─╮ **\n\n {CR}\n\n**╰─..★.─────────✨─╯ **\n\n➽──────'[𓆩♡𓆪𝗔𝗦𝗣𓆩☻𓆪](https://t.me/ASPSIR9)────────❥'
                ccm = f'\n┌── ⋆⋅☆⋅⋆ ──┐**\n✦ {str(count).zfill(3)} ✦\n**└── ⋆⋅☆⋅⋆ ──┘ \n\n**🎵 Title :** `{name1}`\n**├── Extention :**  @ASPSIR01 .mp3\n\n** 🎯  𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘 ➥** `{b_name}`\n\n**🥏 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ➽** \n\n╭─✨─────────.★..─╮ **\n\n{CR}\n\n**╰─..★.─────────✨─╯ **\n\n➽──────'[𓆩♡𓆪𝗔𝗦𝗣𓆩☻𓆪](https://t.me/ASPSIR9)────────❥'
                cchtml = f'\n┌── ⋆⋅☆⋅⋆ ──┐**\n✦ {str(count).zfill(3)} ✦\n**└── ⋆⋅☆⋅⋆ ──┘\n\n**🌐 Title :** `{name1}`\n**├── Extention :**  @ASPSIR01 .html\n\n** 🎯  𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘 ➥** `{b_name}`\n\n**🥏 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐁𝐘 ➽** \n\n╭─✨─────────.★..─╮ **\n\n{CR}\n\n**╰─..★.─────────✨─╯ **\n\n➽──────'[𓆩♡𓆪𝗔𝗦𝗣𓆩☻𓆪](https://t.me/ASPSIR9)────────❥'
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝗦𝗔𝗠𝗘𝗘𝗥 𝗝𝗜🐦](https://t.me/ASPSIR01)"
